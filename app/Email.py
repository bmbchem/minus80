...
class Email:
    ...
    def __init__(self, recipient, subject="", body=""):
        ...
        if self.__port == 465:
            ...
            self.__use_ssl = mail_data.get("use_ssl", False)
        self.__context = ssl.create_default_context()
        self.__password = mail_data.get("mail_password", "")
        ...
        try:
            if self.__use_ssl:
                ...
                with smtplib.SMTP_SSL(self.__imap, self.__port,
                    ...
                    # Login only when a password is available.
                    if self.__password:
                ...
                # Use a non-SSL SMTP connection for servers such as mailhub.umass.edu
                # that do not require authentication.
                with smtplib.SMTP(self.__imap, self.__port) as smtp_server:
                    smtp_server.sendmail(self.__sender, self.__recipient,
                        message.as_string())
